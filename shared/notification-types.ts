...
export const NOTIFICATION_TYPES = {
    EXAMPLE_TEST: {
        ...
        color: "success",
        label: "Texte header",
        template: (payload: { variable1: string; variable2: string }) =>
            `${payload.variable1} est défini, tout comme ${payload.variable2}`,
    },
    ORGANIZATION_INVITE: {
    ...
    SUBSCRIPTION_STARTED: {
        ...
        template: (payload: { organizationName: string }) =>
            `Votre abonnement est maintenant actif pour ${payload.organizationName}.`,
    },
    SUBSCRIPTION_CANCELED: {
        ...
        template: (payload: { organizationName: string }) =>
            `Votre abonnement a été annulé pour ${payload.organizationName}.`,
    },
    PAYMENT_FAILED: {
        icon: "mdi-alert",
        color: "error",
...
export type NotificationPayload<T extends NotificationTypes> = Parameters<
    (typeof NOTIFICATION_TYPES)[T]["template"]
>[0];
