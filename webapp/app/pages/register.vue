    ...
    <NuxtLayout name="auth">
        <template #left>
            ...
            <h3 class="mt-n2 text-blue-grey-lighten-3">
                Pas de CB. 14 jours d'essai. Aucun engagement.<br />Vous pouvez tester aujourd'hui.
            </h3>
        </template>
        ...
        <template #right>
            ...
            >
                Vous avez été invité à rejoindre <strong>{{ inviteOrganizationName }}</strong
                >.<br />
            ...
            <v-form ref="form" v-model="isFormValid">
                <v-row class="mt-2">
                    ...
                    <v-col md="12" class="mt-n4">
                        ...
                        <auth-password-strength :password="user.password"></auth-password-strength>
                    </v-col>
...
onMounted(async () => {
    ...
    const info = await api.get<{ organizationName: string; email: string }>(`/auth/invite/check?token=${inviteToken}`, {
        auth: false,
        toast: false,
    });
