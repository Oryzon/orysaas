                ...
                <v-card-text>
                    <v-row>
                        <v-col md="12">
                            ...
                            <p>
                                Vous êtes sur le point de supprimer l'abonnement <strong>{{ entity.title }}</strong
                                >.
                            </p>
...
const handleRemove = async () => {
    const res = await api.remove<{ message: string; entity: Plan }>(`/plan/${props.entity.uuid}`, {
