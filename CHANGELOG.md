...
## [0.1.1]
### Added
- Add the link to legals pages in Register and Contact
- Add a notification to the SaaS owner when a new user subscribe a plan.
...
[0.1.1]: https://github.com/Oryzon/orysaas/releases/tag/0.1.1
